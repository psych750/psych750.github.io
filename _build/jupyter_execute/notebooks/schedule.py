...
# 
# ### At home
# 1. Submit [test assignment](https://psych750.github.io/notebooks/Exercise0-test.html) by Friday (Sept 8) at 9pm.
...
# 1. Catching errors (exceptions) with try/except
# 1. Code review for Exercise 3
# 1. Some more [practice with dictionaries](https://psych750.github.io/notebooks/activity_dictionaries.html)
# 1. Intro to Exercise 4 - modularize your Exercise 3 code & add speech recognition!
# 

# ## Week 5 (Oct 5)
# 
# ### At home
# 1. Review [exception handling](https://docs.python.org/3.7/tutorial/errors.html)
# 2. [Review Fundamentals A](https://psych750.github.io/notebooks/review_of_fundamentals_a.html) - test yourself!!
